...
export type GameMetadata = { id: string; title: string; path: string; vndb_id: string | null; steam_app_id?: string | null; cover_url: string | null; play_time: number; is_finished: boolean; last_played?: string | null; is_hidden?: boolean; show_spoilers?: boolean; game_type?: GameType | null; wine_settings?: WineSettings | null }
